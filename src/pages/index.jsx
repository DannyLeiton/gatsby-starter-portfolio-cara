  ...
  <React.Fragment>
    ...
    <Parallax pages={5}>
      ...
      <Content speed={0.4} offset={0}>
        <Hero>
          <BigTitle>
            Hello, <br /> this is Tremēns Technologies.
          </BigTitle>
          <Subtitle>We develop great ideas to solve real society problems via technology.</Subtitle>
        </Hero>
      </Content>
      <DividerMiddle
      ...
      <Content speed={0.4} offset={1.2} factor={2}>
        <Inner>
          ...
          <ProjectsWrapper>
            <ProjectCard
              title="Bitz"
              link="https://www.bitz.network/"
              bg="linear-gradient(to right, #D4145A 0%, #FBB03B 100%)"
            >
              This project is a collaboration with the bitz app GREAT idea!
            </ProjectCard>
            <ProjectCard
              title="Bretico"
      ...
      <Content speed={0.4} offset={3}>
        <Inner>
          <Title>About</Title>
          <AboutHero>
            <Avatar src={avatar} alt="Tremēns" />
            <AboutSub>
              Useful and entertaining software is hard to find.
            </AboutSub>
          </AboutHero>
          <AboutDesc>
              Tremēns Technologies tries harder to make it happen.
          </AboutDesc>
        </Inner>
      </Content>
      ...
      <Content speed={0.4} offset={4}>
        <Inner>
          ...
          <ContactText>
            Say <a href="mailto:dleitonrivera@gmail.com">Hi</a> or find us on other platforms:{' '}
            <a href="https://www.linkedin.com/company/tremens-technologies/">LinkedIn</a>
          </ContactText>
        </Inner>
        <Footer>
          &copy; 2018 by Tremēns Technologies.
        </Footer>
      </Content>
